 ...
 * ==========
 * Класс галерей
 *  - albums.get(). Возвращает список альбомов
 *  - albums.sort(albums, method). Возвращает отсортированные альбомы
 *  - albums.sortMethod(). Системная функция для методов сортировки альбомов
 *  - albums.show(). Выводит список альбомов
 *  - photos.get(). Возвращает список фотографий в альбомах
 *  - photos.show(). Открывает галерею и показывает фотографии
 *  - close(). Закрывает галерею и удаляет его из DOM
 *
*/
